...
RSpec.describe 'Api::V1::Members', type: :request do
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      it 'creates a new member' do
        ...
        expect do
          post api_v1_members_path, params: { name: member.name,
                                              description: member.description,
                                              facebook_url: member.facebook_url,
                                              instagram_url: member.facebook_url,
                                              linkedin_url: member.facebook_url },
      ...
      it 'renders a JSON response with the new member' do
        ...
        post api_v1_members_path,
             params: { name: member.name,
                       ...
                       facebook_url: member.facebook_url,
                       instagram_url: member.facebook_url,
                       linkedin_url: member.facebook_url }, headers: valid_headers, as: :json
  ...
  describe 'DELETE /destroy' do
    let!(:member) do
      create(:member, name: 'Memberd', description: 'Member to be discarted', facebook_url: 'url',
                      instagram_url: 'url', linkedin_url: 'url')
    end
